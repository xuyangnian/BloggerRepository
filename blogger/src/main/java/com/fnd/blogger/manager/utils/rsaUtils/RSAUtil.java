package com.fnd.blogger.manager.utils.rsaUtils;
...
public class RSAUtil {
    ...
    public static String encryptedDataOnJava(String data, String PUBLICKEY) {
        try {
            data = new String(Base64Utils.encode(encryptByPublicKey(data.getBytes(), PUBLICKEY)));
        } catch (Exception e) {
    ...
    public static String decryptDataOnJava(String data, String PRIVATEKEY) {
        String temp = "";
        try {
            byte[] rs = Base64Utils.decode(data.getBytes());
